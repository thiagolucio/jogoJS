...
var monster = {};
var monsterCaught = 0; //criando um monstro pra contabilizar quantos monstros o heroi pega

//Controle de teclado
var keysDown = {}; //vai receber o valor true quando a tecla for apertada
...
var update = function update(modifier) {
    if (38 in keysDown) {
        //Pressione a seta para cima com codigo keyEvent = 38
    ...
    if (40 in keysDown) {
        //Pressione a seta para baixo com codigo keyEvent = 40
        hero.y += hero.speed * modifier; // o sinal de menos antes do igual ou receber é uma forma de reducao de codigo que é igual a hero.y = hero.y - hero.speed * modifier
    }
    if (37 in keysDown) {
        //Pressione a seta para esquerda com codigo keyEvent = 37
